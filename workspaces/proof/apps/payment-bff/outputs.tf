...
output "api_gateway_endpoints" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.api_gateway_endpoint
  }
}
...
output "api_gateway_ids" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.api_gateway_id
  }
}
...
output "lambda_function_names" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.lambda_function_name
  }
}
...
output "lambda_function_arns" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.lambda_function_arn
  }
}
...
output "lambda_role_arns" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.lambda_role_arn
  }
}
...
output "lambda_log_group_names" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.lambda_log_group_name
  }
}
...
output "secrets" {
  ...
  value = {
    for env, bff in module.payment_bff : env => bff.secrets
  }
  sensitive = true
}
